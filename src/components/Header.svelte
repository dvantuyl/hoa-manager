...
>
	...
	<div class="flex items-center gap-5 lg:hidden">
		<label for="toggle-navigation" class="btn btn-square btn-ghost">
			<svg
		...
		<!-- <button
			...
			><svg
				...
				stroke-linecap="round"
				aria-hidden="true"
				class="w-2.5 stroke-zinc-900 dark:stroke-white"><path d="M.5 1h9M.5 8h9M.5 4.5h9" /></svg
		></button
		> --><a
			aria-label="Home"
			href="/"
		...
		<div class="flex gap-4">
			...
			<button
				...
				><svg
					...
					><path d="M15.224 11.724a5.5 5.5 0 0 1-6.949-6.949 5.5 5.5 0 1 0 6.949 6.949Z" /></svg
				></button
			>
		</div>
