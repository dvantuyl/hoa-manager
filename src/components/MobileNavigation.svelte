...
<div data-headlessui-portal="">
	...
	<div>
		<div
			...
			id="headlessui-dialog-:r2b:"
			role="dialog"
			aria-modal="true"
			data-headlessui-state="open"
		>
			<div
				class="fixed inset-0 top-14 bg-zinc-400/20 backdrop-blur-sm dark:bg-black/40 opacity-100"
			/>
			<div id="headlessui-dialog-panel-:r2c:" data-headlessui-state="open">
				<div
					class="fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between gap-12 px-4 transition sm:px-6 lg:left-72 lg:z-30 lg:px-8 xl:left-80 bg-white dark:bg-zinc-900 opacity-100"
				...
				>
					...
					<div class="hidden lg:block lg:max-w-md lg:flex-auto">
						<button
							type="button"
							class="hidden h-8 w-full items-center gap-2 rounded-full bg-white pl-2 pr-3 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 ui-not-focus-visible:outline-none dark:bg-white/5 dark:text-zinc-400 dark:ring-inset dark:ring-white/10 dark:hover:ring-white/20 lg:flex"
							><svg
								viewBox="0 0 20 20"
								fill="none"
								aria-hidden="true"
								...
								/></svg
							>Find something...<kbd class="ml-auto text-2xs text-zinc-400 dark:text-zinc-500"
								><kbd class="font-sans">Ctrl </kbd><kbd class="font-sans">K</kbd></kbd
							></button
						>
					</div>
					<div class="flex items-center gap-5 lg:hidden">
						<button
							...
							on:click={handleToggleNavigation}
							><svg
								viewBox="0 0 10 9"
								fill="none"
								stroke-linecap="round"
								...
								><path d="m1.5 1 7 7M8.5 1l-7 7" /></svg
							></button
				...
				<div
					class="fixed bottom-0 left-0 top-14 w-full overflow-y-auto bg-white px-4 pb-4 pt-6 shadow-lg shadow-zinc-900/10 ring-1 ring-zinc-900/7.5 dark:bg-zinc-900 dark:ring-zinc-800 min-[416px]:max-w-sm sm:px-6 sm:pb-10 translate-x-0"
						...
						<ul role="list">
							...
							<li class="relative mt-6 md:mt-0">
								...
								<div class="relative mt-3 pl-2">
									<div
										...
										style="height: 64px; top: 32px; border-radius: 8px; opacity: 1;"
									/>
									<div
									...
									<ul role="list" class="border-l border-transparent">
										<li class="relative" data-projection-id="92">
											<a
										...
										<li class="relative" data-projection-id="93">
											<a
												aria-current="page"
											...
											>
											<ul role="list" data-projection-id="94" style="opacity: 1;">
												<li>
													<a
														...
														href="/quickstart#choose-your-client"
														><span class="truncate">Choose your client</span></a
													>
												</li>
												<li>
													<a
														...
														><span class="truncate">Making your first API request</span></a
													>
												</li>
												<li>
													<a
														class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-7 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
														href="/quickstart#whats-next"
														><span class="truncate">What's next?</span></a
													>
												</li>
											</ul>
										</li>
										<li class="relative" data-projection-id="95">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/sdks"><span class="truncate">SDKs</span></a
											>
										</li>
										<li class="relative" data-projection-id="96">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/authentication"><span class="truncate">Authentication</span></a
											>
										</li>
										<li class="relative" data-projection-id="97">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/pagination"><span class="truncate">Pagination</span></a
											>
										</li>
										<li class="relative" data-projection-id="98">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/errors"><span class="truncate">Errors</span></a
											>
										</li>
										<li class="relative" data-projection-id="99">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/webhooks"><span class="truncate">Webhooks</span></a
											>
										</li>
									</ul>
								</div>
							...
							<li class="relative mt-6">
								...
								<div class="relative mt-3 pl-2">
									...
									/>
									<ul role="list" class="border-l border-transparent">
										<li class="relative" data-projection-id="102">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/contacts"><span class="truncate">Contacts</span></a
											>
										</li>
										<li class="relative" data-projection-id="103">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/conversations"><span class="truncate">Conversations</span></a
											>
										</li>
										<li class="relative" data-projection-id="104">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/messages"><span class="truncate">Messages</span></a
											>
										</li>
										<li class="relative" data-projection-id="105">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/groups"><span class="truncate">Groups</span></a
											>
										</li>
										<li class="relative" data-projection-id="106">
											<a
												class="flex justify-between gap-2 py-1 pr-3 text-sm transition pl-4 text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
												href="/attachments"><span class="truncate">Attachments</span></a
											>
										</li>
									</ul>
								</div>
